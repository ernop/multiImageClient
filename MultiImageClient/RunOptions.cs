...
namespace MultiImageClient
{
    ...
    public class RunOptions
    {
        ...
        /// If true, run the one-shot Stage 5 migration of pre-hosting UI
        /// history into B2 and exit (docs/b2-image-hosting-plan.md). Run with
        /// the UI server stopped. Requires EnableB2ImageHosting.
        public bool B2Backfill { get; set; }

        /// With --b2-backfill: report what would be uploaded/rewritten/evicted
