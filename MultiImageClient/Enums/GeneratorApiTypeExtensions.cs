    ...
    public static class GeneratorApiTypeExtensions
    {
        public static string GetFileExtension(this ImageGeneratorApiType generator)
        {
            return generator switch
            {
                ...
                ImageGeneratorApiType.GptImage25Sunburst => ".png",
                ImageGeneratorApiType.GptImage25Flare => ".png",
                ImageGeneratorApiType.GptImage25SunburstEdit => ".png",
                ImageGeneratorApiType.GptImage25FlareEdit => ".png",
                ...
                ImageGeneratorApiType.BFLFlux2Klein9bPreview => ".png",
                ImageGeneratorApiType.BFLFluxKontextPro => ".png",
                ImageGeneratorApiType.BFLFluxKontextMax => ".png",
                ImageGeneratorApiType.BFLFluxPro => ".png",
                ImageGeneratorApiType.BFLFluxDev => ".png",
                ...
                ImageGeneratorApiType.GrokImagineEdit => ".png",
                ImageGeneratorApiType.GrokWebImagine => ".png",
